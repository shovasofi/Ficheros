...
public class EscribirFichData {
	...
	try(
			//True--> si existe el fichero se deja tal como está, pero si no existe crea uno nuevo
			//si no poenemos nada se da por echo que es un false, por lo que si existe el fichero
			//se eliminará y creará uno nuevo
